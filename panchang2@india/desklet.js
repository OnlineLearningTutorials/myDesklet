...
MyDesklet.prototype = {
    ...
    init_at_sunrise: function() {
        ...
        this._sunrise_label.set_text("sunrise: "+this.fTs(this.sunrise));
    ...
    _updateDate: function() {
        ...
        this._sun_deg.set_text("सूर्य-"+parseInt(sunDegrees)+"°");
        this._moon_deg.set_text("चंद्र-"+parseInt(moonDeg)+"°");
