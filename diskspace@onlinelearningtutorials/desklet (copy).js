...
MyDesklet.prototype = {
	...
	setupUI: function() {
		...
		this.drivelabel = new St.Label({style_class:"drivelabel"});
		...
		this.canvas.add_actor(this.drivelabel);
	...
	redraw: function(type, fs, avail, use, size, percentString) {
		...
		this.drivelabel.set_text(percentString+" - "+textSub1+" free of "+textSub2);
		this.drivelabel.style = "font-size: 16px;"
						  + "width: " + absoluteSize + "px;"
						  + "color: " + this.text_color + ";";
