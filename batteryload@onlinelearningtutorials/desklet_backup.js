...
BatteryloadDesklet.prototype = {
    ...
    _init: function(metadata, deskletId) {
        ...
        let settings_list = [
            ...
            ["low-battery-color", "lowBatteryColor"], // Added from schema
            ["show-background", "showBackground"],
            ["hide-decorations", "hideDecorations"],
            ["devfile_capacity", "devfile_capacity"],
            ["devfile_status", "devfile_status"]
        ];

        for (let [remote, local] of settings_list) {
            this.settings.bindProperty(Settings.BindingDirection.IN, remote, local, this.onSettingChanged, null);
        }
